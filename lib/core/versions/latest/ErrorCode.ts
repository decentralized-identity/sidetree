...
export default {
  ...
  DidLongFormOnlyInitialValuesParameterIsAllowed:
  ...
  OperationHeaderMissingOrIncorrectKid:
    'operation_header_missing_or_incorrect_kid',
  OperationHeaderMissingOrUnknownProperty:
    'operation_header_missing_or_unknown_property',
  OperationMissingOrIncorrectSignature:
    'operation_missing_or_incorrect_signature',
  OperationCreatePayloadHasMissingOrInvalidNextRecoveryOtpHash:
    'operation_create_payload_has_missing_or_invalid_next_recovery_otp_hash',
  OperationCreatePayloadHasMissingOrInvalidNextUpdateOtpHash:
    'operation_create_payload_has_missing_or_invalid_next_update_otp_hash',
  ...
  OperationRecoverPayloadHasMissingOrInvalidDidDocument:
    'operation_recover_payload_has_missing_or_invalid_did_document',
  OperationRecoverPayloadHasMissingOrInvalidDidUniqueSuffixType:
    'operation_recover_payload_has_missing_or_invalid_did_unique_suffix_type',
  OperationRecoverPayloadHasMissingOrInvalidNextRecoveryOtpHash:
    'operation_recover_payload_has_missing_or_invalid_next_recovery_otp_hash',
  OperationRecoverPayloadHasMissingOrInvalidNextUpdateOtpHash:
    'operation_recover_payload_has_missing_or_invalid_next_update_otp_hash',
  OperationRecoverPayloadHasMissingOrInvalidRecoveryOtp:
    'operation_recover_payload_has_missing_or_invalid_recovery_otp',
  OperationRecoverPayloadHasMissingOrUnknownProperty:
    'operation_recover_payload_has_missing_or_unknown_property',
  ...
  OperationUpdatePayloadMissingOrInvalidNextUpdateOtpHash:
    'operation_update_payload_missing_or_invalid_next_update_otp_hash',
  OperationUpdatePayloadMissingOrInvalidUpdateOtp:
    'operation_update_payload_missing_or_invalid_update_otp',
  ...
  OperationUpdatePatchPublicKeyAddRecoveryKeyNotAllowed:
    'operation_update_patch_public_key_add_recovery_key_not_allowed',
  OperationUpdatePatchPublicKeyControllerNotAllowed:
    'operation_update_patch_public_key_controller_not_allowed',
  ...
  OperationUpdatePatchServiceEndpointNotString:
    'operation_update_patch_service_endpoint_not_string',
