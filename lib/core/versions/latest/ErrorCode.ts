...
export default {
  ...
  ChunkFileDeltaSizeExceedsLimit: 'batch_file_delta_size_exceeds_limit',
  ChunkFileDeltasNotArrayOfStrings: 'batch_file_deltas_not_array_of_string',
  ChunkFileDeltasPropertyNotArray: 'batch_file_deltas_property_not_array',
  ChunkFileUnexpectedProperty: 'batch_file_unexpected_property',
