...
export default {
  ...
  CoreProofFileHasUnknownProperty: 'core_proof_file_has_unknown_property',
  ...
  ProvisionalProofFileHasUnknownProperty: 'provisional_proof_file_has_unknown_property',
