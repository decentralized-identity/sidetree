...
export default {
  ...
  RecoveryOperationDataMissingOrUnknownProperty: 'recovery_operation_data_missing_or_unknown_property',
  RecoveryOperationDocumentMissing: 'recovery_operation_document_missing',
  RecoveryOperationMissingDidUniqueSuffix: 'recovery_operation_missing_did_unique_suffix',
  RecoveryOperationMissingOrUnknownProperty: 'recovery_operation_missing_or_unknown_property',
  RecoveryOperationRecoveryOtpMissingOrInvalidType: 'recovery_operation_recovery_otp_missing_or_invalid_type',
  RecoveryOperationRecoveryOtpTooLong: 'recovery_operation_recovery_otp_too_long',
  RecoveryOperationSignedDataMissingOrUnknownProperty: 'recovery_operation_signed_data_missing_or_unknown_property',
  RecoveryOperationTypeIncorrect: 'recovery_operation_type_incorrect',
