...
export default {
  ...
  CreateOperationSuffixDataIsNotObject: 'create_operation_suffixData_is_not_object',
  CreateOperationSuffixDataMissingOrNotString: 'create_operation_suffixData_missing_or_not_string',
  CreateOperationSuffixDataMissingOrUnknownProperty: 'create_operation_suffixData_missing_or_unknown_property',
  CreateOperationSuffixDataTypeInvalidCharacter: 'create_operation_suffixData_type_invalid_character',
  CreateOperationSuffixDataTypeIsNotString: 'create_operation_suffixData_type_is_not_string',
  CreateOperationSuffixDataTypeLengtGreaterThanFour: 'create_operation_suffixData_type_length_greater_than_four',
  ...
  DocumentComposerPatchServiceEndpointValueCannotBeAnArray: 'document_composer_service_endpoint_service_endpoint_cannot_be_an_array',
